...
<html:html>
  <head>
    ...
    <script type="text/javascript">
       function addButton()
       {
          window.location="/home/NewFamilyMember.do";
       }
    </script>
        ...
        <div id="page-bgtop">
          <div id="page-bgbtm">
            <div id="content">
              <table width="100%">
                  <tr>
                    <td width="40%"><h2>Family Members</h2></td>
                    <td width="60%"><input type="button" value="Add Family Member"  onclick="addButton()" alt="Add New Family Member" /></td>
                  </tr>
              </table>
              </br><f:breadcrumbs/><p/>
              &nbsp;
              <f:showPaginatedList view="list" url="../EditFamilyMember.do?id=%s"/>   
            </div>
