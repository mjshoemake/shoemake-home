...
public class DeleteUser2_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable  {
    private static final QName ns1_String_1_QNAME = new QName("", "String_1");
    private static final QName ns2_string_TYPE_QNAME = SchemaConstants.QNAME_TYPE_STRING;
    private CombinedSerializer ns2_myns2_string__java_lang_String_String_Serializer;
    
    public DeleteUser2_LiteralSerializer(QName type, String encodingStyle) {
        this(type, encodingStyle, false);
    }
    
    public DeleteUser2_LiteralSerializer(QName type, String encodingStyle, boolean encodeType) {
    ...
    public Object doDeserialize(XMLReader reader,
        ...
        mjs.home.commands.users.client.DeleteUser2 instance = new mjs.home.commands.users.client.DeleteUser2();
        Object member=null;
        QName elementName;
        List values;
        Object value;
    ...
    public void doSerializeAttributes(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        mjs.home.commands.users.client.DeleteUser2 instance = (mjs.home.commands.users.client.DeleteUser2)obj;
