...
<html:html>
  ...
  <body>
    <html:form action="/UpdateUser" focus="username">
             ...
             <td>
                <table cellpadding="0" cellspacing="0">
                   <tr>
                      ...
                      <td class="breadcrumb">Edit&nbsp;<bean:write scope="request" name="editname"/></td>
                   </tr>
                </table>
             </td>
             <td>&nbsp;</td>
          ...
          <tr>
             <td>
                <table width="412" align="center" border="0" cellpadding="0" cellspacing="0">
                   <tr>
                      <td class="title" colspan="5" align="center">Edit User</td>
                   </tr>
                </table>&nbsp;
