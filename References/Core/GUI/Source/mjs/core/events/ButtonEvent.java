...
// proj: ER 6.4 and up
//
// $Archive:   N:/REPOS/Archives/eQuality/web/java/com/witsys/common/core/events/ButtonEvent.java-arc  $
// $Author:   mshoemake  $
// $Revision:   1.0  $
//
...
public class ButtonEvent extends EventObject
{
    ...
    */
   public ButtonEvent(Object source, long buttonID, String buttonCaption)
   {
      super(source);
...
// $Log:   N:/REPOS/Archives/eQuality/web/java/com/witsys/common/core/events/ButtonEvent.java-arc  $
//
