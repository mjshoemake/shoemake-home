...
// proj: ER 6.4 and up
//
// $Archive:   N:/REPOS/Archives/eQuality/web/java/com/witsys/common/core/events/ButtonListenerList.java-arc  $
...
public class ButtonListenerList extends AbstractList
{
   /**
    ...
    */
   public boolean contains(ButtonListener elem)
   {
    ...
    */
   public int indexOf(ButtonListener elem)
   {
    ...
    * @see     Object#equals(Object)
    */
   public synchronized int indexOf(ButtonListener elem, int index)
   {
    ...
    *          returns <code>-1</code> if the object is not found.
    */
   public int lastIndexOf(ButtonListener elem)
   {
    ...
    */
   public synchronized int lastIndexOf(ButtonListener elem, int index)
   {
    ...
    * @see	   List
    */
   public synchronized ButtonListener elementAt(int index)
   {
      return (ButtonListener)(super.base_elementAt(index));
   }
    ...
    */
   public synchronized ButtonListener firstElement()
   {
      return (ButtonListener)(super.base_firstElement());
   }
    ...
    */
   public synchronized ButtonListener lastElement()
   {
      return (ButtonListener)(super.base_lastElement());
   }
    ...
    */
   public synchronized void setElementAt(ButtonListener obj, int index)
   {
    ...
    * @see	   List
    */
   public synchronized void insertElementAt(ButtonListener obj, int index)
   {
    ...
    * @see	   List
    */
   public synchronized void addElement(ButtonListener obj)
   {
    ...
    * @see	List
    */
   public synchronized boolean removeElement(ButtonListener obj)
   {
    ...
    * @since 1.2
    */
   public synchronized ButtonListener get(int index)
   {
      return (ButtonListener)(super.base_get(index));
   }
    ...
    * @since 1.2
    */
   public synchronized ButtonListener set(int index, ButtonListener element)
   {
      return (ButtonListener)(super.base_set(index, (Object)element));
   }
    ...
    * @since 1.2
    */
   public synchronized boolean add(ButtonListener o)
   {
    ...
    * @since 1.2
    */
   public boolean remove(ButtonListener o)
   {
    ...
    * @since 1.2
    */
   public void add(int index, ButtonListener element)
   {
    ...
    * @since 1.2
    */
   public synchronized ButtonListener remove(int index)
   {
      return (ButtonListener)(super.base_remove(index));
   }

   /**
    * @link dependency
    */
   /*# ButtonListener lnkButtonListener; */
}

// $Log:
//  2    Balance   1.1         3/28/2003 9:01:19 AM   Mike Shoemake   Added
//       Togethersoft diagram dependencies.
//  1    Balance   1.0         11/25/2002 10:02:04 AM Mike Shoemake
// $
//
