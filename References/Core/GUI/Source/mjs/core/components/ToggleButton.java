//
// file: WSToggleButton.java
// proj: eQuality 6.1 and up
//
// $Archive:   N:/REPOS/Archives/eQuality/web/java/com/witsys/common/core/components/ToggleButton.java-arc  $
// $Author:   mshoemake  $
// $Revision:   1.3  $
//
...
/**
 * WSToggleButton:  This is the base class for Witness Systems Toggle Buttons. <p>
 ...
 */
public class ToggleButton extends JToggleButton implements Component, EnumerationTypeOwner
{
   /**
    ...
    */
   public ToggleButton(long pObjectId)
   {
      try
      {
   ...
   * 2.  OnButtonClicked of the parent IF the parent implements the
   * WSOwner interface.
   * 3.  OnButtonClicked of the assigned owner if one exists.  If
   * the assigned owner is also the parent, this step is omitted.
   * </pre>
    */
...
// $Log:   N:/REPOS/Archives/eQuality/web/java/com/witsys/common/core/components/ToggleButton.java-arc  $
//
...
//  Initial revision.
//
//     Rev 1.1   Jan 30 2002 10:45:08   hfaynzilberg
//  Added parent notification and a call of the parent's event method in default_mouseReleased()method.
//
