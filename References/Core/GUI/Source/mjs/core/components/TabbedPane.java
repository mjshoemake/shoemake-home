//
// file: WSTabbedPane.java
// proj: eQuality 6.3 and up
//
// $Archive:   N:/REPOS/Archives/eQuality/web/java/com/witsys/common/core/components/TabbedPane.java-arc  $
// $Author:   mshoemake  $
// $Revision:   1.4  $
//
...
/**
 * WSTabbedPane:  This is the base class for Witness Systems tabbed notebook components. <p>
 ...
 */
public class TabbedPane extends JTabbedPane implements Component, Container, EnumerationTypeOwner
{
   /**
    ...
    */
   public TabbedPane(long pObjectId)
   {
      try
      {
   ...
   public java.awt.Component add(java.awt.Component component)
   {
      ...
      {
         // Convert to mjs.core.components.Component.
         Component wsComp = (mjs.core.components.Component) component;
         super.add(wsComp.getObjectName(), (java.awt.Component) wsComp);
      }
      else
      {
         super.add(component);
    ...
    */
   private void propegateFont(Font f)
   {
   ...
   public void removeChangeListener(ComponentListener l)
   {
...
// $Log:   N:/REPOS/Archives/eQuality/web/java/com/witsys/common/core/components/TabbedPane.java-arc  $
//
//     Rev 1.4   Nov 25 2002 15:20:48   mshoemake
//  Update to the listener model.
//
//     Rev 1.3   Nov 25 2002 09:57:24   mshoemake
...
//
//     Rev 1.2   Oct 11 2002 08:54:32   mshoemake
