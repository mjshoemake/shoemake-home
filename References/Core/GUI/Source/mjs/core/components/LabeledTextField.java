//
// file: WSLabeledTextField.java
// desc:
// proj: ER 6.3
//
// $Archive:   N:/REPOS/Archives/eQuality/web/java/com/witsys/common/core/components/LabeledTextField.java-arc  $
// $Author:   mshoemake  $
// $Revision:   1.0  $
//
...
/**
 * WSLabeledTextField is the base class for Witness Systems labeled JComboBox descendents.
...
public class LabeledTextField extends TextField
{
    ...
    * Constructor.
    */
   public LabeledTextField(LabelFactory factory)
   {
      super();
...
// $Log:   N:/REPOS/Archives/eQuality/web/java/com/witsys/common/core/components/LabeledTextField.java-arc  $
//
