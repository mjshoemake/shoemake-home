//
// file: WSMultiLineLabel.java
// proj: eQuality 6.3 and up
//
// $Archive:   N:/REPOS/Archives/eQuality/web/java/com/witsys/common/core/components/MultiLineLabel.java-arc  $
// $Author:   mshoemake  $
// $Revision:   1.2  $
//
...
/**
 * WSMultiLineLabel:  This is the base class for Witness Systems
 * multi-line Labels.  It extends from JTextArea, so the word-wrap functionality is built in.
 */
public class MultiLineLabel extends JTextArea implements Component, Label
{
    ...
    */
   public MultiLineLabel(long pObjectId)
   {
      try
      {
         // Set ObjectID.
...
// $Log:   N:/REPOS/Archives/eQuality/web/java/com/witsys/common/core/components/MultiLineLabel.java-arc  $
//
...
//  Initial revision.
//
//     Rev 1.2   Feb 11 2002 13:06:34   hfaynzilberg
//  declared 'borderLayout' field private
//
//     Rev 1.1   Feb 07 2002 16:08:58   sputtagunta
//  added default fonts
//
