...
//
// $Archive:   N:/REPOS/Archives/eQuality/web/java/com/witsys/common/core/components/Panel.java-arc  $
// $Author:   mshoemake  $
// $Revision:   1.5  $
//
...
/**
 * WSPanel:  This is the base class for Witness Systems selection panels.
 ...
 */
public class Panel extends JPanel implements Component, Container, EnumerationTypeOwner
{
   /**
   ...
   /**
    * Is the internal border for the component enabled?
    */
   private boolean bWSBorderEnabled = true;
   ...
   {
      bdrExternal = border;
      if ((wsBorder != null) && (isWSBorderEnabled()))
      { super.setBorder(wsBorder.createBorder(this, bdrExternal)); }
    ...
    * Is the internal border for the component enabled?
    */
   public boolean isWSBorderEnabled()
   {
      return bWSBorderEnabled;
   }

   /**
    * Is the internal border for the component enabled?
    */
   public void setWSBorderEnabled(boolean enabled)
   {
      bWSBorderEnabled = enabled;
   }
   ...
   {
      this.sFontFamilyName = getFont().getFamily();
      return sFontFamilyName;
   }
   ...
   {
      this.sFontFamilyName = sfontName;
      setFont(new Font(sFontFamilyName, getFont().getStyle(), getFont().getSize()));
   }
   ...
   {
      setFont(new Font(sFontFamilyName, nfontStyle, getFont().getSize()));
   }
   ...
   {
      setFont(new Font(sFontFamilyName, getFont().getStyle(), nfontSize));
   }
...
// $Log:   N:/REPOS/Archives/eQuality/web/java/com/witsys/common/core/components/Panel.java-arc  $
//
//     Rev 1.5   Nov 25 2002 15:20:44   mshoemake
...
//
//     Rev 1.0   Aug 23 2002 14:44:48   mshoemake
//  Initial revision.
//
//     Rev 1.0   Jun 20 2002 17:27:12   mshoemake
//  Initial revision.
//
//     Rev 1.4   Apr 30 2002 16:40:30   mshoemake
//  Added call to autoSize() from setBorderText() method.
//
//     Rev 1.3   Feb 19 2002 17:32:46   sputtagunta
//  Fixed #11621 : Property Sheet should not allow radiobutton width and height to be too small
//
//     Rev 1.2   Feb 06 2002 10:25:32   sputtagunta
//  made code changes to reflect coding standards
//
//     Rev 1.1   Feb 04 2002 18:57:00   sputtagunta
//  Fixed #11621 : Property Sheet should not allow radiobutton width and height to be too small.
//
