//
// file: WSFolderTreeNode.java
// proj: eQuality 6.3 and up
//
// $Archive:   N:/REPOS/Archives/eQuality/web/java/com/witsys/common/core/components/trees/FolderTreeNode.java-arc  $
// $Author:   mshoemake  $
// $Revision:   1.0  $
//
...
/**
 * WSFolderTreeNode:  This is the base class for all folder treenodes.
 */
public abstract class FolderTreeNode extends TreeNode
{
   /**
    * Constructor.
    * @param   factory     The tree node factory.
    */
   public FolderTreeNode(ListItemFactory factory)
   {
      super(factory);
   }
    ...
    */
   public FolderTreeNode(ListItemFactory factory, long pObjectID)
   {
...
// $Log:   N:/REPOS/Archives/eQuality/web/java/com/witsys/common/core/components/trees/FolderTreeNode.java-arc  $
//
