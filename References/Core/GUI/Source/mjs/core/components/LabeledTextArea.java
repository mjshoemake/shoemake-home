//
// file: WSLabeledTextArea.java
// desc:
// proj: ER 6.3
//
// $Archive:   N:/REPOS/Archives/eQuality/web/java/com/witsys/common/core/components/LabeledTextArea.java-arc  $
// $Author:   mshoemake  $
// $Revision:   1.0  $
//
...
/**
 * WSLabeledTextArea is the base class for Witness Systems labeled JComboBox descendents.
...
public class LabeledTextArea extends TextArea
{
    ...
    * Constructor.
    */
   public LabeledTextArea(LabelFactory factory)
   {
      super();
      // Set the default values for the label.
      setAssociatedLabelDefaults(factory);
   }

   /**
    * Constructor.
    */
   public LabeledTextArea(LabelFactory factory, int maxLength)
   {
      super(maxLength);
      // Set the default values for the label.
      setAssociatedLabelDefaults(factory);
    ...
    */
   private void setAssociatedLabelDefaults(LabelFactory factory)
   {
      // Create the label.
...
// $Log:   N:/REPOS/Archives/eQuality/web/java/com/witsys/common/core/components/LabeledTextArea.java-arc  $
//
