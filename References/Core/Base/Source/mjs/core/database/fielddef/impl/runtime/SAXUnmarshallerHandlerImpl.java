...
/**
 * Implementation of {@link UnmarshallerHandler}. This object converts
 * SAX events into unmarshaller events and cooridnates the entire
...
{
   /**
    * This flag is set to true at the startDocument event and false at
    * the endDocument event. Until the first document is unmarshalled,
    * we don't want to return an object. So this variable is
    * initialized to true.
    */
   ...
   /**
    * Returns true if we should be collecting characters in the
    * current element.
    *
...
//
   ...
   /**
    * Stack of collectText flag. False means text can be ignored for
    * this element. Use {@link #elementDepth} and {@link #stackTop} to
    * access the array.
    */
...
//
   /**
    * Submitted patchers in the order they've submitted. Many XML
    * vocabulary doesn't use ID/IDREF at all, so we initialize it with
    * null.
    */
