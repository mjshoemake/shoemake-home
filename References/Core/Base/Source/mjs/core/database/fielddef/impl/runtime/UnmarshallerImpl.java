...
/**
 * Default Unmarshall implementation. <p>
 *
...
public class UnmarshallerImpl extends AbstractUnmarshallerImpl
{
   ...
   /**
    * Creates and configures a new unmarshalling pipe line. Depending
    * on the setting, we put a validator as a filter.
    *
    * @param locator  The object that is responsible to obtain the
    * source location information for {@link ValidationEvent}s.
    * @return         A component that implements both
    * UnmarshallerHandler and ValidationEventHandler. All the parsing
    * errors should be reported to this error handler for the
    * unmarshalling process to work correctly.
    */
   ...
   private final static DefaultHandler dummyHandler = new DefaultHandler();
}
