...
/**
 * Maintains information that needs to be stored across validations of
 * multiple objects. Specifically, this object is responsible for:
 *
 * <ol>
 *   <li> detecting a cycle in a content tree by keeping track of
 *   objects that were validated.
 *   <li> keeping an instance of NamespaceContextImpl, which is shared
 *   by all MSVValidators.
...
class ValidationContext
{
   ...
   /**
    * @param _context       Description of Parameter
    * @param _eventHandler  Description of Parameter
    * @param validateID     if true, ID/IDREF validation will be
    * performed.
    */
...
//
   ...
   public String onIDREF(XMLSerializable referer, String value) throws SAXException
   {
      ...
      if (IDs.contains(value))
         return value;
      // this IDREF has the corresponding ID.
...
//
    ...
    * @param formattedMessage                 Description of Parameter
   ...
   /**
    * Reports an error to the client. This version should be used when
    * an exception is thrown from sub-modules.
    *
    * @param source                           Description of Parameter
    * @param nestedException                  Description of Parameter
    * @exception AbortSerializationException  Description of Exception
    */
