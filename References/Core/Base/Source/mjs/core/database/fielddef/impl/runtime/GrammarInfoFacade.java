 ...
 * dispatches rootElement requests to the underlying GrammarInfo
 * objects.
 *
...
class GrammarInfoFacade implements GrammarInfo
{
   ...
   /**
    * Iterate through the probe points looking for root element
    * collisions. If a duplicate is detected, then multiple root
    * element componenets exist with the same uri:localname
    *
   ...
   /**
    * Obtains a version number of the JAXB RI that has generated the
    * specified context, or null if it fails (for example because it's
    * not generated by JAXB RI.)
    *
    * @param c                  an instance of a generated
    * ObjectFactory class. This will return the version number written
    * into the corresponding JAXBVersion class.
   ...
   private com.sun.msv.grammar.Grammar union(com.sun.msv.grammar.Grammar g1, com.sun.msv.grammar.Grammar g2)
   {
      ...
      return
         new com.sun.msv.grammar.Grammar()
         {
