...
/**
 * Convenient default implementation of {@link
 * UnmarshallingEventHandler} to minimize code generation. <p>
 *
 * For historical reasons, sometimes this type is used where {@link
 * UnmarshallingEventHandler} should be used. Once an exception is in
 * the form of UnmarshalException, we consider it to be already
 * reported to the client app.
 */
public abstract class AbstractUnmarshallingEventHandlerImpl implements UnmarshallingEventHandler
{
   ...
   /**
    * Text type of states encoded into a string. 'L' means a list
    * state.
    */
...
//
    ...
    *
    * @return   The value of the ListState property.
    */
...
//
   /**
    * Called when a RuntimeException is thrown during unmarshalling a
    * text.
    *
   ...
   /**
    * Last resort when something goes terribly wrong within the
    * unmarshaller.
    *
    * @param e                 Description of Parameter
    * @exception SAXException  Description of Exception
   ...
   /**
    * This method is called by the generated derived class when a
    * datatype parse method throws an exception.
    *
    * @param e                 Description of Parameter
    * @exception SAXException  Description of Exception
    */
...
//
          ...
          throws SAXException
   {
      ...
      else
      {
         ...
         context.getCurrentHandler().enterElement(uri, local, qname, atts);
         return null;
         // return null so that the discarder will be ignored
      }
   }
