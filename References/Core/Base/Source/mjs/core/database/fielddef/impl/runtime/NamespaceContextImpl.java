...
/**
 * Implementation of the NamespaceContext2. This class also provides
 * several utility methods for XMLSerializer-derived classes. The
 * startElement method and the endElement method need to be called
...
{
   /**
    * Sequence generator. Used as the last resort to generate unique
    * prefix.
    */
   private int iota = 1;
   ...
   /**
    * Used during the collecting mode to sort out the namespace URIs
    * we need for this element. A map from prefixes to namespace URIs.
    */
...
//
    ...
    * @param preferedPrefix  Description of Parameter
    * @param requirePrefix   true if this is called for attribute
   ...
   public String declareNamespace(String namespaceUri, String preferedPrefix, boolean requirePrefix)
   {
      if (! inCollectingMode)
      {
         if (! requirePrefix && nss.getURI("").equals(namespaceUri))
            return "";
         // can use the default prefix. use it whenever we can
   ...
   /**
    * Obtains the namespace URI currently associated to the given
    * prefix. If no namespace URI is associated, return null.
    *
    * @param prefix  Description of Parameter
    * @return        The value of the NamespaceURI property.
    */
   ...
   /**
    * Sets the current bindings aside and starts a new element
    * context. This method should be called at the beginning of the
    * startElement method of the Serializer implementation.
    */
    ...
    * last startElement method invocation and finalizes them. This
    * method must be called after all the necessary namespace URIs for
    * this element is reported through the declareNamespace method or
   ...
   /**
    * Ends the current element context and gets back to the parent
    * context. This method should be called at the end of the
    * endElement method of derived classes.
    */
