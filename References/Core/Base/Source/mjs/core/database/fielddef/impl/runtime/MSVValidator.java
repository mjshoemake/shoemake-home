...
/**
 * XMLSerializer that calls the native interface of MSV and performs
 * validation. Used in a pair with a ValidationContext.
 *
 * @author   Kohsuke Kawaguchi
 */
public class MSVValidator implements IDContextProvider2, XMLSerializer
{
   /**
   ...
   /**
    * Acceptor stack. Whenever an element is found, the current
    * acceptor is pushed to the stack and new one is created.
    ...
    *
    * @param _jaxbCtx  Description of Parameter
    * @param _ctxt     Description of Parameter
    * @param vo        Description of Parameter
    */
   ...
   /**
    * Validates the specified object and reports any error to the
    * context.
    *
    * @param jaxbCtx           Description of Parameter
   ...
   /**
    * performs the validation to the object specified in the
    * constructor.
    *
    * @exception SAXException  Description of Exception
    */
    ...
    */
   private final static AttributesImpl emptyAttributes = new AttributesImpl();

   /**
    * namespace URI of dummy elements. TODO: allocate one namespace
    * URI for this.
    */
   public final static String DUMMY_ELEMENT_NS =
