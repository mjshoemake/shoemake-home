...
/**
 * XMLSerializer that produces SAX2 events. To marshal an object,
 * create an instance of SAXMarshaller and call the serializeElements
 * method of the XMLSerializable object that you want to marshal.
 *
...
public class SAXMarshaller implements XMLSerializer
{
    ...
    * @param prefixMapper  Description of Parameter
    * @param _owner        Description of Parameter
    */
   ...
   public void startElement(String uri, String local) throws SAXException
   {
      ...
      pushElement(uri, local);
      // memorize element name
   ...
   /**
    * Switches to the "marshal child texts/elements" mode. This method
   ...
   public void endAttributes() throws SAXException
   {
      ...
      _assert(prefix != null);
      // since we've declared it, it should be available
