...
/**
 * Keeps the information about the grammar as a whole. This object is
...
{
   /**
    * Map from {@link QName}s (root tag names) to {@link Class}es of
    * the content interface that should be instanciated.
    */
    ...
    * {@link String}s that represent names of the corresponding
   ...
   /**
    * @param nsUri      Description of Parameter
    * @param localName  Description of Parameter
    * @return           the name of the content interface that is
    * registered with the specified element name.
    */
