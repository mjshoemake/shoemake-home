...
public class DefaultJAXBContextImpl extends JAXBContext
{
   ...
   /**
    * This object keeps information about the grammar. When more than
    * one package are specified, GrammarInfoFacade is used.
    */
   private GrammarInfo gi = null;

   /**
    * This is the constructor used by javax.xml.bind.FactoryFinder
    * which bootstraps the RI. It causes the construction of a
    * JAXBContext that contains a GrammarInfoFacade which is the union
    * of all the generated JAXBContextImpl objects on the contextPath.
    *
    * @param contextPath        Description of Parameter
    * @param classLoader        Description of Parameter
   ...
   /**
    * This constructor is used by the default no-arg constructor in
    * the generated JAXBContextImpl objects. It is also used by the
    * bootstrapping constructor in this class.
    *
    * @param gi  Description of Parameter
    */
   ...
   /**
    * Create a <CODE>Marshaller</CODE> object that can be used to
    * convert a java content-tree into XML data.
    *
    * @return                a <CODE>Marshaller</CODE> object
    * @throws JAXBException  if an error was encountered while
    * creating the <code>Marshaller</code> object
    */
   ...
   /**
    * Create an <CODE>Unmarshaller</CODE> object that can be used to
    * convert XML data into a java content-tree.
    *
    * @return                an <CODE>Unmarshaller</CODE> object
    * @throws JAXBException  if an error was encountered while
    * creating the <code>Unmarshaller</code> object
    */
   ...
   /**
    * Create a <CODE>Validator</CODE> object that can be used to
    * validate a java content-tree.
    *
    * @return                an <CODE>Unmarshaller</CODE> object
    * @throws JAXBException  if an error was encountered while
    * creating the <code>Validator</code> object
    */
    ...
    * @return                      an instance of the Java content
    * interface
    ...
    * Other providers may have support for properties on Validator,
    * but the RI doesn't
    *
    * @param name                   The new Property value.
    * @param value                  The new Property value.
    * @exception PropertyException  Description of Exception
    */
