...
public class ShowPaginatedListTag extends AbstractTag {
   ...
   /**
    * The class name of the form used for the filter mechanism when view=details. 
    */
      ...
      try {
         ...
         if (obj != null && obj instanceof PaginatedList) {
            ...
            if (list.getPageCount() > 1) {
               ...
               out.println("                " + list.getCurrentPage() + " of " + list.getPageCount());
               out.println("                &nbsp;&nbsp;&nbsp;&nbsp;");
               out.println("                &nbsp;&nbsp;&nbsp;&nbsp;");
               out.println("                &nbsp;&nbsp;&nbsp;&nbsp;");
            ...
            if (view.equalsIgnoreCase("list")) {
               ...
               for (int i = 0; i <= items.size() - 1; i++) {
                  ...
                  if (obj2 instanceof BusinessObject) {
                     ...
                     log.error("Item #" + (i + 1) + ": unexpected object found.  Type=" + obj2.getClass().getName());
                  }
               }
               ...
               for (int j = 0; j <= column1.size() - 1; j++) {
                  ...
                  bizObj = (BusinessObject) column1.get(j);
                  String name = bizObj.getName();
                  String id = null;
                  String newUrl = null;
                  if (url != null) {
                     id = bizObj.getPK();
                  ...
                  out.println("              <td width=\"30%\"><li><a href=\"" + newUrl + "\">" + name + "</a></li></td>");
                  if (j < column2.size()) {
                     bizObj = (BusinessObject) column2.get(j);
                     name = bizObj.getName();
                     if (url != null) {
                        id = bizObj.getPK();
                        newUrl = String.format(url, id);
                  ...
                  if (j < column3.size()) {
                     bizObj = (BusinessObject) column3.get(j);
                     name = bizObj.getName();
                     if (url != null) {
                        id = bizObj.getPK();
                        newUrl = String.format(url, id);
               ...
               out.println("          <form name=\"" + formName + "\" method=\"post\" action=\"" + list.getFilterAction() + "\">");
               ...
               while (iter.hasNext()) {
                  ...
                  if (nextField.getType() != null && nextField.getType().equalsIgnoreCase("key")) {
               ...
               while (iter.hasNext()) {
                  ...
                  if (nextField.getType() != null && nextField.getType().equalsIgnoreCase("key")) {
                     ...
                     out.println("            <td>");
                     String value = "";
                     Map<String,String> searchCriteria = (Map<String,String>)tag.getRequest().getSession().getAttribute(Constants.ATT_SEARCH_CRITERIA);
   ...
   /**
    * Returns the width of the filter edit box/picklist for a
    * particular 
