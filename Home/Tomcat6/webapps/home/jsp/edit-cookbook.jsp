    ...
    <div id="wrapper">
      ...
      <div id="page">
        <div id="page-bgtop">
          <div id="page-bgbtm">
            <div id="content">
              <html:form action="/UpdateCookbook" focus="name">
              <table width="900px">
                 <tr>
                   <td width="40%"><h2>Edit Cookbook</h2></td>
                   <td width="60%"><html:hidden property="cookbooks_pk"/>&nbsp;</td>
                </tr>
              </table>
              </br><f:breadcrumbs/></p>
                <table width="100%">
                  ...
                  <tr>
                    <td class="form">&nbsp;</td>
                    <td class="form">Cookbook Name: </td>
                    <td class="form">&nbsp;</td>
