...
<html:html>
  <head>
    ...
    <script type="text/javascript">
       ...
       {
     	  // MJS: TODO: Create custom tag for writing out DynaActionForm properties. 
<%--          window.location="/home/DeleteFamilyMember.do?family_member_pk=<c:out value="${FamilyMemberForm.family_member_pk}"/>";  --%>
          window.location="/home/DeleteFamilyMember.do?family_member_pk=<bean:write name="FamilyMemberForm" property="family_member_pk" />"; 
       }
    </script>
    ...
    <div id="wrapper">
      ...
      <div id="page">
        <div id="page-bgtop">
          <div id="page-bgbtm">
            <div id="content">
              <html:form action="/UpdateFamilyMember" focus="name">
              <table width="900px">
                 <tr>
                   <td width="40%"><h2>Edit Family Member</h2></td>
                   <td width="60%"><input type="button" value="Delete " onclick="deleteButton()" alt="Delete Family Member" /></td>
                </tr>
              </table>
              </br><f:breadcrumbs/></p>
              <html:hidden property="family_member_pk"/>
                <table width="100%">
                  <tr>
                    <td width="2%">&nbsp;</td>
                    <td width="17%">&nbsp;</td>
