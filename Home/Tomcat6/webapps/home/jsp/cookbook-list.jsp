...
<html:html>
  <head>
    ...
    <script type="text/javascript">
       function addButton()
       {
          window.location="/home/NewCookbook.do";
       }
    </script>
        ...
        <div id="page-bgtop">
          <div id="page-bgbtm">
            <div id="content">
              <table width="100%">
                  <tr>
                    <td width="40%"><h2>Cookbooks</h2></td>
                    <td width="60%"><input type="button" value="Add Cookbook"  onclick="addButton()" alt="Add New Cookbook" /></td>
                  </tr>
              </table>
              </br><f:breadcrumbs/><p/>
              &nbsp;
              <f:showPaginatedList view="list" url="../EditCookbook.do?id=%s"/>
            </div>
